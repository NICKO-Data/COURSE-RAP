CLASS zcl_ce_rap_agency_NO12 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zrap_NO12z_travel_agency_es5-agencyid.
    TYPES t_business_data TYPE TABLE OF zrap_NO12z_travel_agency_es5.
...
CLASS zcl_ce_rap_agency_NO12 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_NO12' ).
