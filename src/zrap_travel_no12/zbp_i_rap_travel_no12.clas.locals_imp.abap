...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD calculateTotalPrice.
    ...
    MODIFY ENTITIES OF zi_rap_travel_no12 IN LOCAL MODE
      ENTITY travel
  ...
  METHOD calculateTravelID.
    ...
    READ ENTITIES OF zi_rap_travel_NO12 IN LOCAL MODE
      ENTITY Travel
  ...
  METHOD validateAgency.
    ...
    ENTITY travel FIELDS ( agencyid ) WITH CORRESPONDING #( keys ) RESULT DATA(travels).

    agencies = CORRESPONDING #( travels DISCARDING DUPLICATES MAPPING agency_id = agencyid EXCEPT * ).

    IF agencies IS NOT INITIAL.

      SELECT agency_ID FROM /dmo/agency
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky        = travel-%tky
                        %state_area = 'VALIDATE_AGENCY'
                        %msg        = NEW zcm_rap_no12(
                                          severity = if_abap_behv_message=>severity-error
                                          textid   = zcm_rap_no12=>agency_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         ...
                         %msg        = NEW zcm_rap_NO12(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = zcm_rap_NO12=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_NO12(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_NO12=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_NO12(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_NO12=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
...
*                                       requested_authorizations-%action-Edit         = if_abap_behv=>mk-on OR
   ...
   IF is_update_requested = abap_true.
         ...
         IF has_before_image = abap_true.
           ...
           IF update_granted = abap_false.
             APPEND VALUE #( %tky        = travel-%tky
                             %msg        = NEW zcm_rap_NO12( severity = if_abap_behv_message=>severity-error
                                                             textid   = zcm_rap_NO12=>unauthorized )
                           ) TO reported-travel.
           ENDIF.
  ...
  METHOD is_create_granted.
    AUTHORITY-CHECK OBJECT 'ZOSTATNO12'
      ID 'ZOSTATNO12' DUMMY
      ID 'ACTVT' FIELD '01'.
  ...
  IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'ZOSTATNO12'
        ID 'ZOSTATNO12' FIELD overall_status
        ID 'ACTVT' FIELD '06'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'ZOSTATNO12'
        ID 'ZOSTATNO12' DUMMY
